    ...
    <Wrapper class="header__wrapper">
      <div class="header__content">
        ...
        <nav class="header__nav">
          <a href="#" class="header__nav__link">Dashboard</a>
          <a href="#" class="header__nav__link">Analytics</a>
          <a href="#" class="header__nav__link">Reports</a>
        </nav>
        <div class="header__actions">
          <button class="header__icon-btn" title="Paramètres">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
          ...
          <button class="header__icon-btn" title="Déconnexion">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
